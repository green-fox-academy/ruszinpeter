...
class Blogpost {
  ...
  checkMyPostIt():void {
    console.log(`'name:' ${this.authorName} 'Title:' ${this.title} 'Text:' ${this.text} 'Date:' ${this.publicationDate}`)
  }
}
...
blogpost1.checkMyPostIt();
blogpost2.checkMyPostIt();
blogpost3.checkMyPostIt();